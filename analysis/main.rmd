...
df = bind_rows(read_sim("optimal"), filter(human, trial_num > 10), read_sim("rand_gamma")) %>% 
...
[see here](report4ken-alltrials-21-06-01.html).
Most of the effects are non-significant (sometimes even entirely absent). See
[here](multi_recall_earlylate-21-06-01.html)
