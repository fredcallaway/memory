...
- Provide binary feedback in the first two rounds of training
...
- Like the last round but unlike earlier rounds, we're not dropping the first half of trials
- Strength is measured by the last round only, as before (but this doesn't make much difference)
:::
