...
::: {.alert .alert-info}
These are results where memory strength is measured in a single cue recall task
rather than the 2-AFC task.
:::
...
A simple (although perahps naïve) test of rational memory: Do people spend
